...
## Javascript Assignments  [![Build Status](https://travis-ci.org/rolling-scopes-school/eqxBarboss.svg?branch=master)](https://travis-ci.org/rolling-scopes-school/eqxBarboss)
...
* Run `git clone https://github.com/<your-account>/eqxBarboss.git` from command line to download the repo.

### How to setup travis-ci
* Open [https://travis-ci.org/](https://travis-ci.org/) and sign in with your github account.
* Activate your forked repo **eqxBarboss**.
...
```
* Open https://github.com/eqxBarboss/rolling-scopes-school and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
...
* Push your updates to github server and check if tests passed on [travis-ci](https://travis-ci.org/rolling-scopes-school/eqxBarboss/builds).
