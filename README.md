...
```
* Open https://github.com/rolling-scopes-school/eqxBarboss and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
